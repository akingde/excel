...
public class ExcelReadContext<T> implements Serializable {
    ...
    private List<ExcelMessage> errorMessageList = new ArrayList<>();
    ...
    public List<ExcelMessage> getErrorMessageList() {
        return errorMessageList;
    }

    public void setErrorMessageList(List<ExcelMessage> errorMessageList) {
        this.errorMessageList = errorMessageList;
    }

    public boolean isHasError() {
        return errorMessageList != null && errorMessageList.size() > 0;
    }
    ...
    public void incSuccessRowCount() {
        this.successRowCount++;
    }

    public void desSuccessRowCount() {
        this.successRowCount--;
    }
